...
export const metadata: Metadata = {
  title: 'Quality & Certifications | De&apos;Hydra Exports',
  description:
    'De&apos;Hydra Exports holds ISO 22000, HACCP, and organic certifications. Learn about our global quality assurance standards.',
  keywords: 'quality, certifications, ISO 22000, HACCP, organic, compliance',
  openGraph: {
    title: 'Quality & Certifications | De&apos;Hydra Exports',
    description: 'Global compliance and quality assurance standards.',
    url: 'https://dehydra-b2b.com/quality',
    type: 'website',
  },
};
...
const CERTIFICATES = [
  {
    name: 'ISO 22000:2018',
    description:
      'Food Safety Management System (FSMS) certification ensuring every step of our supply chain meets global safety requirements for human consumption.',
    ref: 'ISO-DEH-2024',
    size: '2.4MB',
    icon: ShieldCheck,
  },
  {
    ...
    description:
      'Hazard Analysis and Critical Control Points protocol implementation to prevent chemical, physical, and biological hazards in production.',
    ref: 'HC-9921-X',
    size: '1.1MB',
    icon: BadgeCheck,
  },
  {
    ...
    description:
      'Dual certification for international organic trade. Validates zero synthetic pesticide usage and non-GMO procurement processes across all De&apos;Hydra sourcing farms.',
    isMajor: true,
  ...
  },
  {
    name: 'FSSAI License',
    description:
      'Central License from the Food Safety and Standards Authority of India for high-capacity export operations.',
  ...
  },
  {
    name: 'GMP Certified',
    description:
      'Good Manufacturing Practices certification ensuring consistent production and quality control according to international standards.',
    ref: 'Ref: GMP-DH-24',
    size: '1.5MB',
    icon: Settings,
  },
...
export default function QualityPage() {
  return (
    <main className="max-w-7xl mx-auto px-8 py-20 bg-background">
      {/* Hero Section */}
      <section className="mb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          <span className="text-primary font-label-sm uppercase mb-4 block tracking-widest">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {CERTIFICATES.map((cert) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`p-8 border border-outline-variant bg-white flex flex-col justify-between hover:border-primary transition-all rounded-sm shadow-sm group ${
                cert.isMajor ? 'lg:row-span-2' : ''
              }`}
            >
              <div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container-low">
                  <th className="p-6 font-label-sm text-primary uppercase tracking-wider border-b border-outline-variant">
                    Date
                  </th>
                  <th className="p-6 font-label-sm text-primary uppercase tracking-wider border-b border-outline-variant">
                    Audit Agency
                  ...
                  <th className="p-6 font-label-sm text-primary uppercase tracking-wider border-b border-outline-variant text-right">
                    Report
                  </th>
                </tr>
              </thead>
      ...
      >
        ...
        <div className="md:col-span-2 relative z-10">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-xl" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="bg-white text-primary font-label-sm px-8 py-3 whitespace-nowrap hover:bg-primary-fixed transition-colors rounded font-bold uppercase tracking-widest shadow-lg active:scale-95"
            >
              Request Access
            </button>
          </form>
