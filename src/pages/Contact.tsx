  ...
  return (
    <main className="pt-12 pb-24">
      <div className="max-w-7xl mx-auto px-8">
        ...
        >
          <span className="label-sm text-primary uppercase tracking-[0.2em] mb-4 block">Institutional Organic Export</span>
          ...
          >
            <div className="p-4 border border-outline-variant bg-surface-container-lowest flex flex-col gap-6 rounded-sm shadow-sm">
              <div className="flex items-start gap-4 p-4 hover:bg-surface-container-low transition-colors rounded-lg">
                <MapPin className="text-primary w-6 h-6 shrink-0" fill="currentColor" fillOpacity={0.1} />
                <div>
                  <h3 className="text-h3 text-primary mb-2 text-xl font-bold">Headquarters</h3>
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    Industrial District 4, Logistics Hub<br />Dubai, United Arab Emirates
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 hover:bg-surface-container-low transition-colors rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    exports@dehydra.com<br />support@dehydra.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 hover:bg-surface-container-low transition-colors rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    +971 4 555 0192<br />Mon - Fri: 09:00 - 18:00 GST
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="h-64 bg-slate-200 rounded-xl overflow-hidden relative group border border-outline-variant shadow-sm">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuC_MdNk9hJaFlYBIzIL9TLxB90vBki2VcxO53ySXTFmlzDAzpN2aqq8V6pULnj5T_bWtQA1pqzIEKIyDFN4E6TSVm2BgrPxZ4kehU0KMqYNrSlFCDNEDYCjFa_h0OnfdS0ByLmnMw1WmjN32ItV83niuM39zuOg0AW-7oqYMWTPZL5y5hMAwHR3CF3QQXY-Uu7aUt82_9nTDmlcNxp_RAQ-uHE5gNCPD5P-RpZzmMFAnEk-vUs2pJph7pv7QE-o2pfwEFbfdvmtOYk" 
              />
              ...
              <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="label-sm text-on-surface-variant uppercase text-xs">Name</label>
                    <input 
                  ...
                  <div className="space-y-2">
                    <label className="label-sm text-on-surface-variant uppercase text-xs">Company</label>
                    <input 
                      className="w-full bg-transparent border-b border-outline-variant focus:border-primary focus:ring-0 px-0 py-3 transition-colors outline-none text-body-md placeholder:text-outline-variant" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="label-sm text-on-surface-variant uppercase text-xs">Country</label>
                  ...
                  <div className="space-y-2">
                    <label className="label-sm text-on-surface-variant uppercase text-xs">Product Interest</label>
                    <select className="w-full bg-transparent border-b border-outline-variant focus:border-primary focus:ring-0 px-0 py-3 transition-colors outline-none text-body-md appearance-none cursor-pointer">
                ...
                <div className="space-y-2">
                  <label className="label-sm text-on-surface-variant uppercase text-xs">Quantity (Metric Tons)</label>
                  <input 
                    className="w-full bg-transparent border-b border-outline-variant focus:border-primary focus:ring-0 px-0 py-3 transition-colors outline-none text-body-md placeholder:text-outline-variant" 
                ...
                <div className="space-y-2">
                  <label className="label-sm text-on-surface-variant uppercase text-xs">Message</label>
                  <textarea 
                ...
                <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-2 text-on-surface-variant">
                    ...
                    <span className="text-[10px] uppercase tracking-wider font-bold">ISO 9001:2015 Encrypted</span>
                  </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            <div className="col-span-1">
              ...
              <p className="text-on-surface-variant mb-6 leading-relaxed">Our network spans 45 countries, ensuring seamless distribution of high-grade organic products from harvest to warehouse.</p>
              <div className="flex flex-wrap gap-2">
                {['Europe', 'APAC', 'MENA', 'Americas'].map(region => (
                  <span key={region} className="px-3 py-1 bg-surface-container-high rounded-full text-[10px] font-bold text-primary uppercase tracking-widest border border-outline-variant">
                    {region}
                  </span>
                ))}
              </div>
            ...
            <div className="col-span-1 md:col-span-2 aspect-[21/9] bg-surface-container-low rounded-2xl overflow-hidden relative border border-outline-variant shadow-inner group">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQrMrKwmKjwTrrmJVlJkk_1Z5Y9SqrYwlLJXh1vohAXRP53mpiRvAFmXTgMkPPRjL51nnW_A_YtRYDoHltIsNRR3fWyD_IVRSPO41U93u_hPcYSEKl8tZjiygeQ1jtPmEe_c4Y-N4UkeN7Sw9mFOqDbXauSKPXvFPJl_zb3RCCu_gyOFQjXrf2u6daaRFGE9qvGginE7i-1NZxO7IV_VLiuVDPv7FCOKKmznZbfI_-6WoeMhYgEQ8_shg_hTEHs9heNrbGFoqdeyY" 
              />
